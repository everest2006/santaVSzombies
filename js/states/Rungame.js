module.exports = {
    ...
    create: function() {
        ...
        // houses
        this.roades = zombiegame.world.createRoad(5, 260, 'h1', null, zombiegame.rungame.gamespeed);
        zombiegame.world.createRoad(230, 290, 'h2', this.roades, zombiegame.rungame.gamespeed);
        zombiegame.world.createRoad(400, 270, 'h1', this.roades, zombiegame.rungame.gamespeed);
        zombiegame.world.createRoad(600, 220, 'h1', this.roades, zombiegame.rungame.gamespeed);
        zombiegame.world.createRoad(800, 280, 'h2', this.roades, zombiegame.rungame.gamespeed);
        ...
        zombiegame.rungame.bloodEmitter.minParticleSpeed.setTo(0, 0);
        zombiegame.rungame.bloodEmitter.maxParticleSpeed.setTo(100, 100);
    ...
    update: function() {
        ...
        zombiegame.world.rotateRoades(this.roades);

        // Collide the player with houses
        this.game.physics.arcade.collide(this.player.sprite, this.roades);

        // Collide the zombies with houses
        this.game.physics.arcade.collide(this.zombies, this.roades);
    ...
    updateGameOver: function() {
        if(this.player.isDead) {
            ...
            if(zombiegame.rungame.gamespeed > 0) {
                ...
                this.roades.setAll("body.velocity.x", -zombiegame.rungame.gamespeed, true);
